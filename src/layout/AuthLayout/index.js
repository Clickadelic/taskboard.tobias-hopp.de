		...
		<>
			<aside className="App-sidebar Auth-Sidebar hidden md:block fixed top-0 left-0 w-64 min-h-screen bg-white shadow">
				...
				<section className="sidebar-section mt-10 mb-6">
					...
					<ul className="sidebar-nav">
						<li><a href="/projekte" className="block px-4 py-2 hover:bg-slate-100 hover:border-r-2 border-slate-400">Mindestlohndokumente</a></li>
						<li><a href="/" className="block px-4 py-2 hover:bg-slate-100 hover:border-r-2 border-slate-400">Systemnutzer Übersicht</a></li>
						<li><a href="/" className="block px-4 py-2 hover:bg-slate-100 hover:border-r-2 border-slate-400">Zugriffs-Kontrolleinheiten</a></li>
					</ul>
				</section>
			</aside>
			<header className="App-header flex fixed top-0 md:ml-64 w-screen p-2 bg-white shadow">
				<nav className="flex justify-between w-max">
					<span className="p-0">
						...
						<button className="bg-slate-200 hidden md:inline hover:bg-slate-300 ml-3 mr-1 rounded p-2 pt-2" id="btn-sidebar-toggle">
