	...
	return(
		<div className="w-[600px] backdrop-blur-sm rounded p-12 m-auto">
			<header className=" bg-black rounded flex justify-between">
				...
				<button className="relative top-0 right-0 border border-white text-white w-24">
			...
			<section className="bg-yellow-400 p-12 rounded">
				...
				<form className="w-full" onSubmit={handleSubmit}>
					<div className="mb-4">
						<label htmlFor="username" className="block text-2xl mb-2">Benutzername:</label>
					...
					<p>Ich habe mein Passwort vergessen?<a href="https://www.example.com" target="_blank">Register</a></p>
				</form>
			</section>
		</div>
	)
