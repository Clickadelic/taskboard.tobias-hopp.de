		...
		<div class="bg-white">
			...
			<header class="absolute inset-x-0 top-0 z-50">
				...
				<div class="flex lg:flex-1">
					...
					<img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=teal&shade=600" alt="" />
					</a>
				</div>
				...
				<div class="hidden lg:flex lg:gap-x-12">
					<a href="#" class="text-sm font-semibold leading-6 text-gray-900">Produkt</a>
					<a href="#" class="text-sm font-semibold leading-6 text-gray-900">Funktionen</a>
					<a href="#" class="text-sm font-semibold leading-6 text-gray-900">Administration</a>
